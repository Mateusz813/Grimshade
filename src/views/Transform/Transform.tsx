...
const Transform = () => {
  ...
  const { language } = useSettingsStore(useShallow((s) => ({ language: s.language })));
  ...
  const {
    ...
    autoPotionPctHpId,
    autoPotionPctMpId,
  } = useSettingsStore(useShallow((s) => ({ skillMode: s.skillMode, setSkillMode: s.setSkillMode, autoPotionHpEnabled: s.autoPotionHpEnabled, autoPotionMpEnabled: s.autoPotionMpEnabled, autoPotionHpId: s.autoPotionHpId, autoPotionMpId: s.autoPotionMpId, autoPotionPctHpId: s.autoPotionPctHpId, autoPotionPctMpId: s.autoPotionPctMpId })));
